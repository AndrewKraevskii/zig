...
test "blake2s160 streaming" {
    ...
    h = Blake2s160.init(.{ .context = @as([8]u8, @splat(0x69)), .salt = @as([8]u8, @splat(0x42)) });
    h.update(a32);
    h.update(b32);
    h.final(out[0..]);
...
test "blake2s224 streaming" {
    ...
    h = Blake2s224.init(.{ .context = @as([8]u8, @splat(0x69)), .salt = @as([8]u8, @splat(0x42)) });
    h.update(a32);
    h.update(b32);
    h.final(out[0..]);
    try htest.assertEqual(h4, out[0..]);
...
test "blake2b160 streaming" {
    ...
    h = Blake2b160.init(.{ .context = @as([16]u8, @splat(0x69)), .salt = @as([16]u8, @splat(0x42)) });
    h.update(a64);
    h.update(b64);
    h.final(out[0..]);
    try htest.assertEqual(h4, out[0..]);
...
test "blake2b384 streaming" {
    ...
    h = Blake2b384.init(.{ .context = @as([16]u8, @splat(0x69)), .salt = @as([16]u8, @splat(0x42)) });
    h.update(a64);
    h.update(b64);
    h.final(out[0..]);
    try htest.assertEqual(h4, out[0..]);
